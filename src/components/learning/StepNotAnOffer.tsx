...
const items = [
  ...
  { text: "Repeatable Fixed-Scope D365 Implementation Package", isOffer: true, why: "This solution solves a common problem for multiple customers and can be reused — that's what makes it an offer, not just the fixed scope or price (which alone would be a fixed-fee project). Can be used as is." },
